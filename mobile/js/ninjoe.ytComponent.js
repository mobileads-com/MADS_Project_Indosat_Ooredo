...
ytComponent.prototype.onAdClose = function(){
	var _this = this;
	nj.fn.listen({
	    "callback": function(data) {
	      	if (typeof data.auth != "undefined" && typeof data.auth.type != "undefined" && data.auth.type == "closeExpandable") {
